import {realCup,realPour} from './pouring.mjs?v=8';
...
export function sceneArt(kind,config=defaults){
 ...
 const backdrop=`<img class="scene-backdrop" src="assets/${farm?'coffee-colombia':'coffee-bar-brown'}.png" alt="">${kind==='origins'?'<img class="harvest-full" src="assets/coffee-colombia-full.jpg" alt="">':''}`;

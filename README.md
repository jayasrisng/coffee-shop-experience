...
4. **Follow the story.** A portrait 4:5 animation moves through an illustrated coffee harvest, roasting, espresso, milk, ice, and the final lid.
...
| SVG | The original sun-and-cup logo, product decals, and programmable preparation visuals |
| Built-in image generation | Photorealistic cup cutouts, the menu product grid, and illustrated café/farm scenes |
...
| 30–39 seconds | Preparation begins; the selected espresso shots |
| 39–47 seconds | Selected cold milk and optional vanilla sweetness |
| 47–53 seconds | Regular ice, light ice, or no ice |
| 53–60 seconds | The lid and final cup reveal |
| 60 seconds | Automatic pickup screen |

### Layered visuals that respond to the order

The story combines generated background plates with SVG/CSS effects: moving cherries, roasted beans, pouring liquid, milk ribbons, falling ice, and a settling lid. Preparation visuals respond to the selected recipe. Photorealistic generated cups appear in the menu, receipt, and finished reveal, including a separate no-ice cutout.
...
├── timeline.test.mjs
├── visuals.mjs                # Cup renderers and animated scenes
